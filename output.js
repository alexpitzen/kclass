...
@media screen and (width:960px) and (height:600px) {
    ...
    body:has(.worksheet-tool):not(:has(.content-answer-content)):has(div.worksheet-container.landscape.selected) .headerZindexBtn {
        left: 676px;
    }
    body:has(.worksheet-tool):not(:has(.content-answer-content)):has(div.worksheet-group.landscape.selected) .headerZindexBtn {
        left: 676px;
    }
